import json
def main():
    with open("one_word_dataset/whisper_wordlist.json", "r") as f:
        word_dic_whisper = json.load(f)
    with open("one_word_dataset/dstc2_wordlist.json", "r") as f:
    ...
    for word in word_dic_dstc2:
        if "\u0120"+word in word_dic_whisper:
            ...
            cor_dic[word_dic_dstc2[word]] = word_dic_whisper["\u0121" + word]
    with open("one_word_dataset/correspondence_table.json", "w") as f:
